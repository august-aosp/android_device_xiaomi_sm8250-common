...
# Audio
ifeq ($(TARGET_BOOTLOADER_BOARD_NAME), lito)
...
SOONG_CONFIG_NAMESPACES += PLATFORM_ROOTDIR
SOONG_CONFIG_PLATFORM_ROOTDIR := PLATFORM_TYPE
ifeq ($(TARGET_BOARD_PLATFORM),lito)
SOONG_CONFIG_PLATFORM_ROOTDIR_PLATFORM_TYPE := lito
else
SOONG_CONFIG_PLATFORM_ROOTDIR_PLATFORM_TYPE := kona
endif
