...
$(call soong_config_set,libcameraservice,ext_lib,//$(LOCAL_PATH):libcameraservice_extension.$(TARGET_BOARD_PLATFORM))
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/task_profiles/cgroups.json:$(TARGET_COPY_OUT_VENDOR)/etc/cgroups.json \
